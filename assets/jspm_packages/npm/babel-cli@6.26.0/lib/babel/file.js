  ...
  module.exports = function(commander, filenames, opts) {
    ...
    var stdin = function stdin() {
      ...
      process.stdin.on("end", function() {
        results.push(util.transform(commander.filename, code, {sourceFileName: "stdin"}));
        output();
      });
    };
    var walk = function walk() {
      ...
      _filenames.forEach(function(filename) {
        ...
        var data = util.compile(filename, {sourceFileName: sourceFilename});
        if (data.ignored)
          return;
        results.push(data);
      });
    ...
    var files = function files() {
      ...
      if (commander.watch) {
        ...
        chokidar.watch(filenames, {
          ...
          if (util.shouldIgnore(filename) || !util.canCompile(filename, commander.extensions))
            return;
