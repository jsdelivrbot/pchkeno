...
(function(process) {
	...
	var OptionManager = (function() {
		...
		OptionManager.normalisePlugins = function normalisePlugins(
			...
			return plugins.map(function(val, i) {
				...
				if (typeof plugin === 'string') {
					var pluginLoc =
						(0, _resolve2.default)('babel-plugin-' + plugin, dirname) ||
						(0, _resolve2.default)(plugin, dirname);
					if (pluginLoc) {
		...
		OptionManager.prototype.mergeOptions = function mergeOptions(_ref2) {
			...
			if (opts.presets) {
				if (opts.passPerPreset) {
					opts.presets = this.resolvePresets(opts.presets, dirname, function(
						preset,
						presetLoc
					) {
						_this.mergeOptions({
			...
			return presets.map(function(val) {
				...
				try {
					if (typeof val === 'string') {
						presetLoc =
							(0, _resolve2.default)('babel-preset-' + val, dirname) ||
							(0, _resolve2.default)(val, dirname);
						if (!presetLoc) {
		...
		OptionManager.prototype.init = function init() {
			...
			for (
				var _iterator2 = (0, _buildConfigChain2.default)(opts, this.log),
