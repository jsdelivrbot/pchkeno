						...
						x = function(t) {
							...
							if ('string' == typeof n && n.length > 2) {
								...
								var r,
									...
									o = n.charCodeAt(0);
								if (43 === o || 45 === o) {
									if (((r = n.charCodeAt(2)), 88 === r || 120 === r))
										return NaN;
								} else if (48 === o) {
				...
				function(t, n, r) {
					...
					var e = t(38),
						...
						Z = function getOwnPropertyDescriptor(t, n) {
							if (
								((t = m(t)), (n = w(n, !0)), t !== W || !i(G, n) || i(D, n))
							) {
								var r = A(t, n);
								return (
									!r || !i(G, n) || (i(t, T) && t[T][n]) || (r.enumerable = !0),
									r
								);
							}
						},
					...
					(function(t) {
						!(function(t) {
							...
							function AsyncIterator(t) {
								function invoke(n, r, e, i) {
									...
									if ('throw' !== o.type) {
										var u = o.arg,
											c = u.value;
										return c instanceof AwaitArgument
											? Promise.resolve(c.arg).then(
													function(t) {
														invoke('next', t, e, i);
													},
													function(t) {
							...
							var a = 'suspendedStart',
								...
								h = 'completed',
								v = {},
								p = (GeneratorFunctionPrototype.prototype =
									Generator.prototype);
