...
// flip animation
document.querySelector('.animate--flip').addEventListener(
	'click',
	function() {
...
// slide animation
document.querySelector('.animate--slide').addEventListener(
	'click',
	function() {
...
// out/in example
document.querySelector('.animate--outin').addEventListener(
	'click',
	function() {
		animate.animateOutIn(
			document.querySelectorAll('#example4, #example5'),
			'slideOutDown',
			'slideInUp',
			function(el) {
...
// fade out/in example
document.querySelector('.animate--fadeoutin').addEventListener(
	'click',
	function() {
		animate.fadeOutIn(
			document.querySelectorAll('#example4, #example5'),
...
document.querySelector('.animate--fadeoutinpersist').addEventListener(
	'click',
	function() {
		animate.fadeOutIn(
			document.querySelectorAll('#example4, #example5'),
...
document.querySelector('.animate--jquery').addEventListener(
	'click',
	function() {
		animate.fadeOutIn(
			$('#example6, #example7'),
...
document.querySelector('.animate--trans').addEventListener(
	'click',
	function() {
